  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        timeline: {
          main: "hsl(var(--timeline-main))",
          "branch-1": "hsl(var(--timeline-branch-1))",
          "branch-2": "hsl(var(--timeline-branch-2))",
          "branch-3": "hsl(var(--timeline-branch-3))",
          "branch-4": "hsl(var(--timeline-branch-4))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
